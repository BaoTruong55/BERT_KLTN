...
url = "4098456"
total = 1
pathSaveCSV = 'crawlVnExp-temp.csv'
...
listIdPost = getIdPostByCategory(categoryThoiSu, '1/5/2020', '20/5/2020')

# print(listIdPost)
# for idPost in listIdPost:
#     print("Post: [{post}]".format(post = idPost))
